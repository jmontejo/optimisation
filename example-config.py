...
Config.signal = Sample("stop_600_300", Utils.load_chain(["testSamples/default13/stop_600_300/*.root"], "CollectionTree"), ROOT.kRed)
Config.backgrounds = [
	Sample("ttbar", Utils.load_chain(["testSamples/default13/ttbar1/*.root"], "CollectionTree"), ROOT.kBlue),
	Sample("ttV", Utils.load_chain(["testSamples/default13/ttV/*.root"], "CollectionTree"), ROOT.kGreen),
	Sample("Wjets", Utils.load_chain(["testSamples/default13/wjets/*.root"], "CollectionTree"), ROOT.kOrange),
]
